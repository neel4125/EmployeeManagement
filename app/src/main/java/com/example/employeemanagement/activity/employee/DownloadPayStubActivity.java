...
public class DownloadPayStubActivity extends AppCompatActivity {
    RelativeLayout downloadPaystub;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_download_pay_stub);
        downloadPaystub = (RelativeLayout)findViewById(R.id.downloadPaystub);
        ...
        DownloadUrl = Constants.employee.getPaystub();
        if(DownloadUrl != null)
        {
            try {
        ...
        downloadPaystub.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(Constants.employee.getPaystub() == null)
                {
                    Toast.makeText(DownloadPayStubActivity.this,"No paystub found",Toast.LENGTH_SHORT).show();
                    return;
                }
...
//                Log.e("File Name","Is "+name+" Extension="+extension);
    ...
    public void downloadFile() {
        ...
        if(DownloadUrl != null) {
            String fileName = Constants.employee.getFirst_name()+"_Pay_Stub_"+Constants.employee.getUserId()+extension;
