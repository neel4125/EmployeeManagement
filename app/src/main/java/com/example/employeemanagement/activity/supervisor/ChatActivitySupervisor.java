...
public class ChatActivitySupervisor extends AppCompatActivity {
    ImageView ic_back;
       ...
       listner1 =  mDatabase.child("User").orderByChild("userType").equalTo("Employee")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot snapshot) {
                        ...
                        Collections.sort(myListData, new CustomComparator());
                        Collections.reverse(myListData);
                        //Attaching recycler view to custom adapter and passing arraylist
                        RecyclerView recyclerView = (RecyclerView) findViewById(R.id.recyclerView);
                        EmployeeChatAdapter adapter = new EmployeeChatAdapter(myListData, ChatActivitySupervisor.this,Tag);
                        recyclerView.setHasFixedSize(true);
                        recyclerView.setLayoutManager(new LinearLayoutManager(ChatActivitySupervisor.this));
