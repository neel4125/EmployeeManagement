...
public class UploadPayStubActivity extends AppCompatActivity {
    CircleImageView imgEmployee;
    TextView txtEmployeeName,txtAnnouncement;
    RelativeLayout uploadPaystub;
    ImageView imgBack;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_pay_stub_details);
        ...
        uploadPaystub = (RelativeLayout)findViewById(R.id.uploadPaystub);
        ...
        uploadPaystub.setOnClickListener(new View.OnClickListener() {
            @Override
            ...
            case FILE_SELECT_CODE:
                if (resultCode == RESULT_OK) {
                   ...
                   String uploadedFile = "Documents/"+uri.getLastPathSegment();
                    ...
                    StorageReference riversRef = storageReference.child("Documents/PayStub/"+uri.getLastPathSegment());
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            riversRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                   ...
                                   Constants.selectedEmployee.setPaystub(documentURL);
                                    UpdateUserObject();
                                }
                            });
    ...
    private void UpdateUserObject() {
        mDatabase.child("User").child(Constants.selectedEmployee.getUserId()).setValue(Constants.selectedEmployee, new DatabaseReference.CompletionListener() {
            ...
            public void onComplete(DatabaseError databaseError,
                ...
                {
                    Toast.makeText(UploadPayStubActivity.this,"Paystub uploaded",Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(UploadPayStubActivity.this,MainActivitySupervisor.class);
                    finishAffinity();
