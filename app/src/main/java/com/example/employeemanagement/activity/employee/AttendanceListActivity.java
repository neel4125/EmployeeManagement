        ...
        mDatabase.child("Attendance").child(Constants.employee.getUserId())
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot snapshot) {
                        ...
                        AttendanceAdapter adapter = new AttendanceAdapter(announcementArrayList,AttendanceListActivity.this);
                        recyclerView.setHasFixedSize(true);
                        recyclerView.setLayoutManager(new LinearLayoutManager(AttendanceListActivity.this));
