...
public class ViewAttendanceActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(Constants.selectedEmployee != null)
        {
            ...
            userPosition.setText(Constants.selectedEmployee.getDesignation());
        }
        ...
        mDatabase.child("Attendance").child(Constants.selectedEmployee.getUserId())
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot snapshot) {
                        ...
                        AttendanceAdapter adapter = new AttendanceAdapter(announcementArrayList, ViewAttendanceActivity.this);
